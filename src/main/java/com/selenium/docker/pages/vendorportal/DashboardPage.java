package com.selenium.docker.pages.vendorportal;
...
public class DashboardPage extends AbstractPage {
    ...
    private WebElement modalLogoutButtonElement;
    ...
    @Override
    public boolean isAt() {
        this.wait.until(ExpectedConditions.visibilityOf(availableInventoryElement));
    ...
    public void logout() {
        ...
        this.wait.until(ExpectedConditions.visibilityOf(this.modalLogoutButtonElement));
        this.modalLogoutButtonElement.click();
    }
}
