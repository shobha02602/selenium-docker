...
public class RegistrationPage extends AbstractPage {
    ...
    //creating a constructor through which we'll accept webdriver

    public RegistrationPage(WebDriver driver) {
        super(driver);
        //this.driver = driver;
        //using this driver initialize all above elements
    ...
    //opening browser and going to registration page
